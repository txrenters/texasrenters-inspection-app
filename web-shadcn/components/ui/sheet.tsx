 ...
 *
 * A sheet is full-height by definition, so its header and footer have to stay
 * put while the content between them scrolls — otherwise a long list pushes the
 * close button off the bottom of the viewport.
 */
