...
// Radix Select measures its trigger before opening; jsdom implements neither.
if (hasDom && typeof Element.prototype.scrollIntoView === 'undefined') {
  Element.prototype.scrollIntoView = () => {};
}

// next-themes reads matchMedia on mount to resolve the `system` preference.
