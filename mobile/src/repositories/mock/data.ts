...
export const properties: Property[] = [
  ...
  },
  {
    ...
    address: '772 Willow Creek Road',
    cityStateZip: 'Pflugerville, TX 78660',
    bedrooms: 3,
    bathrooms: 2,
    floors: ['Ground Floor'],
    accessInstructions: 'Unit A is on the west side; Unit B is on the east side.',
...
export const inspections: Inspection[] = [
  ...
  {
    id: 'inspection-willow-b',
    externalInspectionId: 'EXT-INSP-2026-0718-006',
    propertyId: 'property-willow-creek',
    unitId: 'unit-willow-b',
    unitName: 'B',
    type: 'MOVE_IN',
...
export const rooms: InspectionRoom[] = [
  ...
  ...simpleRooms('inspection-willow-b', 'Ground Floor', 6, 'MOVE_IN').map((room) => ({
    ...room,
    completionStatus: 'NOT_STARTED' as const,
    uploadStatus: 'PENDING' as const,
    processingStatus: 'NOT_STARTED' as const,
