...
export const AREA_ENVIRONMENTS: readonly { value: AreaEnvironment; label: string }[] = [
 ...
 */
export function groupRoomsBySection(rooms: InspectionRoom[]): {
  key: AreaGroupKey;
  label: string;
  ...
  const sections: { key: AreaGroupKey; label: string; rooms: InspectionRoom[] }[] = [
